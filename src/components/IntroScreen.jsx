            ...
            steps: [
                {
                    ...
                    content: [
                        ...
                        '',
                        '🔺 **3. Klasse Mathematik - Geometrische Formen**',
                        '  → Grundschüler lernen Formen erkennen und verstehen',
                        '  → Eigenschaften von Formen in der Umgebung identifizieren',
                        '',
                        '🧪 **8. Klasse Chemie - Chemische Reaktionen**',
                        '  → Versuchsabläufe durchführen und dokumentieren',
                        '  → Praktische Fertigkeiten mit Theorie verbinden',
                        '',
                        '📜 **11. Klasse Geschichte - Historische Quellenanalyse**',
                        '  → Verschiedene historische Quellen analysieren',
                        '  → Glaubwürdigkeit bewerten und Interpretationen entwickeln',
                        '',
                ...
                },
                {
                    ...
                    content: [
                        ...
                        '• **Geometrische Formen**: Modellgrafiken, Systemübersichten',
                        '• **Chemische Reaktionen**: Virtuelle Labore, Moodle-Tests, Simulationsumgebungen',
                        '• **Historische Quellenanalyse**: Vergleichende Theoriebewertung, Argumentativer Blogeintrag, Bewertungsrubriken',
                        '',
            ...
            steps: [
                {
                    ...
                    content: [
                        ...
                        '',
                        '🔺 **3rd Grade Mathematics - Geometric Shapes**',
                        '  → Elementary students learning to recognize and understand shapes',
                        '  → Identifying shape properties in their environment',
                        '',
                        '🧪 **Middle School Chemistry - Chemical Reactions**',
                        '  → Conducting and documenting experimental procedures',
                        '  → Connecting practical skills with theoretical understanding',
                        '',
                        '📜 **High School History - Historical Source Analysis**',
                        '  → Analyzing various historical sources',
                        '  → Evaluating credibility and developing interpretations',
                        '',
                ...
                },
                {
                    ...
                    content: [
                        ...
                        '• **Geometric Shapes**: Model graphics, system overviews',
                        '• **Chemical Reactions**: Virtual labs, Moodle tests, simulation environments',
                        '• **Historical Source Analysis**: Comparative theory evaluation, argumentative blog posts, evaluation rubrics',
                        '',
